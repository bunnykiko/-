...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton_12.clicked.connect(lambda: self.insertTask(int(self.lineEdit.text()),self.lineEdit_2.text(),self.lineEdit_3.text(),self.dateEdit.text(),self.dateEdit_2.text(),self.comboBox.currentText()))
    ...
    #print(f"{id_tr},{description},{status},{date_start},{date_end},{id_st}")
        if description == '' or  name == '' or status == '' or start_date == '' or end_date == '' :
            ...
            query = QSqlQuery()
            query.prepare(F"INSERT INTO travel_packages (name,description,status,start_date,end_date,id_pr) VALUES ('{name}','{description}','{status}','{start_date}','{end_date}',{id_pr})")
